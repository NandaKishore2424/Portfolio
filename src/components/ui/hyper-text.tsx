...
// From Magic UI (Hyper Text); adds `uppercase` and `letterClassName` options.
import {
  useEffect,
  useRef,
  useState,
...
interface HyperTextProps extends Omit<MotionProps, "children"> {
  ...
  /** Render letters in upper case (the original behaviour). */
  uppercase?: boolean
  /** Class applied to each letter; defaults to the monospace face. */
